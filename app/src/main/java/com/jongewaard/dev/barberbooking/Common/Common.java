package com.jongewaard.dev.barberbooking.Common;
...
public class Common {
    ...
    public static final String KEY_SALOON_STORE = "SALOON_SAVE";
    ...
    public static SimpleDateFormat simpleFormatDate = new SimpleDateFormat("dd_MM_yyyy"); //Only use when format key
